...
(function () {
    ...
    var KB = [
        ...
        },
        {
            ...
            topic: 'regulations',
            answer: 'Operations over people have <strong>4 categories</strong>:<br><br><strong>Category 1:</strong> Aircraft weighs <strong>0.55 lbs (250g) or less</strong> including everything on board. No exposed rotating parts that could lacerate skin.<br><br><strong>Category 2:</strong> Must not cause injury as severe as a rigid object with <strong>11 ft-lbs</strong> of kinetic energy, and no exposed rotating parts that could lacerate skin. Requires a <strong>Declaration of Compliance</strong> based on an FAA-accepted means of compliance.<br><br><strong>Category 3:</strong> Higher injury threshold than Category 2 &mdash; must not cause injury as severe as a rigid object with <strong>25 ft-lbs</strong> of kinetic energy. Additionally, it <strong>cannot sustain flight over open-air assemblies</strong> of people, and may only fly over people who are under a covered structure or inside a stationary vehicle. Also requires a Declaration of Compliance.<br><br><strong>Category 4:</strong> Requires an <strong>airworthiness certificate</strong> and must operate within its operating limitations. Equivalent to certified manned aircraft standards.'
        },
        {
